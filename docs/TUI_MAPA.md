...
| ETAPY DALEJ: 2 edycja padów (±uderzenia, X, „postaw tu" z odtwarzacza, werdykty) · 3 odsłuch od pada (ffplay -ss już umie) · 4 zapis `rekordbox_cue_writer.write_plan` + kolizje `resolve_conflicts` (skip/replace/merge) + playlista | — |
