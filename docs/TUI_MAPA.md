...
| P = odsłuch SAMEGO zaznaczonego utworu (afplay; podział Janka 06.08: „P otwiera 1 utwór, przejście mamy od C"); szew gra przycisk ▶ w pasku szwu — `tui/seam_preview.zbuduj_szew` na maszynerii `preview/transition_simulation` (fraz-lock, cache); dźwięk TYLKO z jawnego klawisza, drugie P/Esc stop, koniec z aplikacją | P w zakładce Set · ▶ w #compare |
