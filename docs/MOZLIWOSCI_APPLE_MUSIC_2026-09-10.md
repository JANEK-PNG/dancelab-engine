...
| **MusicKit na Web** — odtwarzanie pełnych utworów w przeglądarce dla subskrybenta | oba | działa w Safari (autoryzacja przeszła); **w WKWebView okna DanceLab — nie sprawdzone** | odsłuch 82 % kolekcji w oknie zamiast 30 s próbki — jeśli WKWebView przepuści DRM |
